...
// Whether the browser can decode H.264 via the WebCodecs VideoDecoder API.
// noVNC only advertises the Open H.264 encoding (50) when this is true.
...
async function _checkWebCodecsH264DecodeSupport() {
    ...
    // Firefox incorrectly reports support for H.264 under some circumstances,
    // so decode a real frame to make sure.
